...
my $entitlements = $client->call('channel.software.availableEntitlements', $session , 'rhel-x86_64-server-6.4.z','regular');

#my $entitlements = $client->call('channel.software.availableEntitlements', $session , 'rhel-x86_64-server-6.4.z','flex');
